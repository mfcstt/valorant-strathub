<div class="px-4 md:px-8 lg:px-16 xl:px-24 pt-16 pb-5"> 
  ...
  <?php if (($total_pages ?? 1) > 1): ?>
    ...
    <nav class="mt-6 flex items-center justify-center gap-3">
      <a href="/explore?<?= $prevQuery ?>" class="px-4 py-2 rounded-md bg-gray-1/80 border border-gray-3 text-gray-5 outline-none hover:text-red-light hover:border-red-base focus:text-red-light focus:outline-red-base transition-all">Anterior</a>
      <span class="px-3 py-2 text-gray-6">Página <?= $page ?? 1 ?> de <?= $total_pages ?></span>
      <a href="/explore?<?= $nextQuery ?>" class="px-4 py-2 rounded-md bg-gray-1/80 border border-gray-3 text-gray-5 outline-none hover:text-red-light hover:border-red-base focus:text-red-light focus:outline-red-base transition-all">Próxima</a>
    </nav>
  <?php endif; ?>
