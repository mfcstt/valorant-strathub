  ...
  <form class="w-full flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8" method="post" novalidate>
    ...
    <div class="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
                ...
                <?php
                    ...
                    $orderEmoji = $orderEmojiMap[$order] ?? '⭐';
                ?>
                <div class="sm:w-56 relative flex items-center">
                    ...
                    <span class="text-xl absolute left-4 top-1/2 -translate-y-1/2 pointer-events-none text-gray-5" title="Ordenação selecionada"><?= $orderEmoji ?></span>
                </div>
