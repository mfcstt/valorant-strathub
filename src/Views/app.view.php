        ...
        <div class="flex items-center gap-2 pr-3 border-r border-gray-3">
          ...
          <?php if ($user !== null): ?>
            <a href="/profile" title="Abrir perfil"
              class="relative rounded-md w-9 h-9 overflow-hidden border border-[#7435DB] bg-gray-3 outline-none focus:outline-red-base">
    ...
    <nav class="flex flex-col" aria-label="Navegação mobile">
      ...
      <?php if ($user !== null): ?>
        <a href="/profile" class="flex items-center gap-3 px-4 py-3 hover:bg-gray-2">
          <img src="<?= e($avatarUrl) ?>" alt="" class="w-9 h-9 rounded-md border border-[#7435DB] object-cover">
          <span class="flex-1">
